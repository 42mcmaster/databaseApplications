# Lesson 01 – Setup & Your First Program
...
Before we write anything, let's look at what's already in `main.py`. You've seen Python before, but some of this will look new — that's expected. We'll go through it line by line.
...
> **You don't need to memorize the imports.** Every new project starts with these automatically. Over the next few lessons you'll learn what each one does as we use it.
...
Now let's write something of our own. Replace **everything** in `main.py` with the code below. Read every comment — they explain what each line does.
...
*Next up → **Lesson 02: Motors & Motion** — you'll make things move with a single motor.*
